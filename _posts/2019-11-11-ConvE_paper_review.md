 ...
 *link prediction*은 scoring function $$\psi:\mathcal{E}\times\mathcal{R}\times\mathcal{E}\mapsto\mathds{R}$$을 평가하는 포인트 단위 학습으로 형식화 될 수 있다. 
주어진 입력 트리플 $$x=\left(s,r,o\right)$$과 그 점수$$\psi\left(x\right)\in\mathds{R}$$는 $$x$$가 참일 가능성에 비례한다.    
